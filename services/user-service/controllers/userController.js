...
const searchUsers = async (req, res, next) => {
  try {
    ...
    // Search by name, username, or email alias
...
export default { getProfile, updateProfile, getSettings, updateSettings, followUser, blockUser, listProfiles, submitKYC, getKYCStatus, verifyKYC, searchUsers };
