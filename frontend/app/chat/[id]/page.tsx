    ...
    <div className={clsx('flex gap-2 group px-4 mb-3', isMe ? 'justify-end' : 'justify-start')}>
      ...
      <div className="max-w-[75%] space-y-1">
        ...
        <div className={clsx('relative px-4 py-3 rounded-2xl shadow-sm',
          isMe ? 'bg-blue-600 text-white rounded-br-sm' : 'bg-[var(--bg-elevated)] text-[var(--text-primary)] rounded-bl-sm border border-white/5',
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--bg-primary)] overflow-hidden">
      ...
      {/* ── Header ── */}
      <div className="bg-[var(--bg-card)]/90 backdrop-blur-xl border-b border-white/5 px-4 py-3 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        <div className="flex items-center gap-3">
          <button onClick={() => router.back()} className="p-2 hover:bg-[var(--bg-elevated)] rounded-xl"><ArrowLeft size={20} className="text-[var(--text-primary)]"/></button>
      ...
      {/* ── Input ── */}
      <div className="bg-[var(--bg-card)] border-t border-white/5 p-3 relative z-10">
